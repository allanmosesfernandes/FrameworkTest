	...
	return (
		<section className="bg-spaceBlue flex lg:flex-row flex-col-reverse font-sora justify-center lg:px-10 pt-[8.5rem] px-4 gap-6 overflow-hidden mb-20">
			...
			<div className="lg:w-6/12 w-full flex flex-col mt-10">
				<p className="spacedText">The Global Challenge</p>
				...
				<p className="bodycopy mb-8">
					...
					elementum interdum scelerisque quisque donec nulla. Velit diam quam
					nullam elit hac sit. Nunc, lacus, facilisis mattis amet mauris
					volutpat dui tellus nam. Neque, rhoncus placerat vitae arcu habitant.
					Dignissim quam ipsum dolor egestas non orci. At enim ut elementum.
				</p>
