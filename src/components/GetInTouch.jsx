...
function GetInTouch() {
    return (
			<div className="get-in-touch bg-contactBG h-screen bg-cover bg-center flex flex-col items-center justify-center">
				<div className="absolute w-full h-screen bg-blueGradient z-1"></div>
