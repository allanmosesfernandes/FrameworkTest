...
const Mission = forwardRef((props, ref) => {
	return (
		<section
			ref={ref}
			className="bg-spaceBlue flex md:flex-row flex-col font-sora justify-center lg:p-10 pt-10 px-4"
		>
			{/* Left */}
			...
			<div className="md:w-8/12 w-full flex flex-col justify-center items-baseline">
				<p
					id="mission"
					className="subheading md:text-4xl text-2xl md:leading-60 leading-38 md:mt-0 mt-2 md:mb-12 mb-8"
				>
